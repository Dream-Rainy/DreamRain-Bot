# https://github.com/watermellye/pcr_calculator_plus/blob/master/util/pack.py
import re
...
class Pack():
    def __init__(self, D: int | None = None, T: int | None = None):
        """
...
class PackDT(Pack):
    ...
    def ToString(self, b: PackB | None = None) -> str:
