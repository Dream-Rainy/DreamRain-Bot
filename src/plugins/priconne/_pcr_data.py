...
CHARA_NAME = {
    ...
    1002: ["优衣", "ユイ", "Yui", "种田", "普田", "由衣", "结衣", "ue", "↗↘↗↘","u1"],
    ...
    1061: ["矛依未", "ムイミ", "Muimi", "诺维姆", "Noemu", "夏娜", "511", "无意义", "天楼霸断剑", "姆咪", "母咪","611"],
    ...
    1068: ["拉比林斯达", "ラビリスタ", "Labyrista", "Rabirisuta", "菈比莉斯塔", "迷宫女王", "模索路晶", "模索路", "晶", "迷宫女", "王晶", "晶姐", "日日日"],
    1069: ["霸瞳皇帝", "カイザーインサイト", "Mana", "Kaiser Insight", "真那", "千里真那", "千里", "霸瞳", "霸铜","八筒"],
    ...
    1094: ["古蕾娅", "グレア", "Gurea", "Grea", "龙姬", "古雷娅", "古蕾亚", "古雷亚", "古蕾雅", "🐲🐔", "🐉🐔","龙女"],
    ...
    1163: ["琪爱儿(圣学祭)", "チエル(聖学祭)", "Chieru(Seigakusai)", "Chieru(SchoolFestival)", "SFChieru", "千爱瑠(圣学祭)", "运动切噜", "圣学祭切噜", "圣学祭琪爱儿", "圣学祭千爱瑠", "圣爱瑠", "圣切噜", "圣切"],
    1164: ["优妮(圣学祭)", "ユニ(聖学祭)", "Yuni(Seigakusai)", "Yuni(SchoolFestival)", "SFYuni", "圣优妮", "圣uni", "运动优妮", "运动服", "罗塞塔"],
    1165: ["祈梨(时空旅行)", "イノリ(タイムトラベル)", "Inori(TimeTravel)", "Inori(TimeTraveller)", "TTInori", "祈梨(时间旅行)", "时间旅行龙锤", "穿越龙锤", "穿越梨老八", "军装龙锤", "元首龙锤", "元首", "元老八", "时锤"],
    1166: ["嘉夜(时空旅行)", "カヤ(タイムトラベル)", "Kaya(TimeTravel)", "Kaya(TimeTraveller)", "TTKaya", "嘉夜(时间旅行)", "时间旅行龙拳", "穿越龙拳", "水手龙", "水手龙拳", "时空龙拳", "白龙拳"],
    1167: ["碧(工作服)", "アオイ(作業服)", "Aoi(Sagyoufuku)", "Aoi(Work)", "WAoi", "碧(作业服)", "工菜", "韭菜", "工作碧", "贡菜"],
    1168: ["珠希(工作服)", "タマキ(作業服)", "Tamaki(Sagyoufuku)", "Tamaki(Work)", "WTamaki", "珠希(作业服)", "工猫贼", "工猫剑", "工贼", "工珠希", "工猫"],
    1169: ["美冬(工作服)", "ミフユ(作業服)", "Mifuyu(Sagyoufuku)", "Mifuyu(Work)", "WMifuyu", "美冬(作业服)", "电子龙", "工子龙", "工龙", "工头"],
    ...
    1179: ["铃奈(万圣节)", "スズナ(ハロウィン)", "Suzuna(Halloween)", "HSuzuna", "万圣暴弓", "瓜弓", "瓜暴弓", "万圣爆弓", "瓜爆弓", "鬼暴", "鬼暴弓","瓜爆"],
    ...
    1191: ["空花(黑暗)", "クウカ(ノワール)", "Kuuka(Noir)", "NKuuka", "黑m", "暗m", "黑花", "黑空花"],
    ...
    1213: ["胡桃(舞台)", "クルミ(ステージ)", "Kurumi(Stage)", "STKurumi", "舞台胡桃", "舞桃", "演员", "舞胡", "芜湖", "舞铃", "舞台铃", "戏铃","50"],
    1214: ["美咲(舞台)", "ミサキ(ステージ)", "Misaki(Satge)", "STMisaki", "舞台大眼", "舞台眼", "舞台美咲", "泥头车大眼", "车眼","舞眼"],
    1215: ["步未(怪盗)", "アユミ(怪盗)", "Ayumi(Kaitou)", "Ayumi(PhantomThief)", "PTAyumi", "怪盗路人", "怪盗路人妹", "怪盗妹"],
    1216: ["祈梨(怪盗)", "イノリ(怪盗)", "Inori(Kaitou)", "Inori(PhantomThief)", "PTInori", "怪盗祈梨", "怪盗龙锤", "忍龙", "忍龙锤", "忍锤"],
    ...
    1223: ["班比", "ヴァンピィ", "Vampy", "Vania", "斑比", "斑比酱", "钉宫"],
    1224: ["日和(夏日)", "ヒヨリ(サマー)", "Hiyori(Summer)", "SHiyori", "日和莉(夏日)", "水猫拳", "水日和"],
    1225: ["怜(夏日)", "レイ(サマー)", "Rei(Summer)", "SRei", "水怜", "水剑圣", "水剑"],
    ...
    1232: ["绫音(探险家)", "アヤネ(エクスプローラー)", "Ayane(Explorer)", "EAyane", "绫音(探索者)", "野锤", "野炊", "探锤"],
    1233: ["涅娅", "ネア", "Nea", "涅亚", "小黄", "史莱姆", "黄史莱姆"],
    1234: ["纯(露营)", "ジュン(キャンプ)", "Jun(Camp)"],
    1235: ["铃(万圣节)", "リン(ハロウィン)", "Rin(Halloween)", "HRin", "瓜松鼠", "鬼松鼠", "万圣松鼠", "瓜松", "鬼松","瓜鼠"],
    ...
    1242: ["纯(圣诞节)", "ジュン(クリスマス)", "Jun(Xmas)", "Jun(Holiday)", "XJun", "白骑", "圣黑骑", "圣诞黑骑"],
    1243: ["安(安&古蕾娅)", "アン(アン&グレア)", "An(An&Gurea)", "安(安&古蕾雅)"],
    1244: ["古蕾娅(安&古蕾娅)", "グレア(アン&グレア)", "Gurea(An&Gurea)", "古蕾雅(安&古蕾雅)"],
    ...
    1248: ["望(解放者)", "ノゾミ(リベレイター)", "Nozomi(Liberator)", "LNozomi", "解望", "充电望", "白望", "女神望", "解放望", "光望"],
    ...
    1253: ["可可萝(游侠)", "コッコロ(レンジャー)", "Kokkoro(Ranger)", "RKokkoro", "可可萝(游骑兵)", "游妈", "狗妈", "游侠可可萝", "游侠妈", "游白"],
    1254: ["栞(游侠)", "シオリ(レンジャー)", "Shiori(Ranger)", "RShiori", "栞(游骑兵)", "游栞", "游侠栞", "游侠tp弓", "狼栞"],
    1255: ["吉塔(术士)", "ジータ(ウォーロック)", "Djeeta(Warlock)", "WDjeeta", "姬塔(术士)", "魔姬", "魔吉", "魔法姬塔", "魔法吉他", "魔塔", "法吉", "法鸡","法姬"],
    1256: ["碧卡拉", "ビカラ", "Vikala", "毗伽菈", "鼠鼠", "鼠大将", "鼠妹"],
    1257: ["花凛(炼金术师)", "カリン(アルケミスト)", "Karin(Alchemist)", "AKarin", "绿术", "绿发术士", "炼金恶魔", "魔绿", "术花凛", "炼金花凛"],
    1258: ["莉莉(堕落)", "リリ(フォールン)", "Riri(Fallen)", "FRiri", "莉莉(堕天使)", "莉莉"],

    1260: ["可璃亚(堕落)", "クリア(フォールン)", "Qualia(Fallen)", "Quria(Fallen)", "FQuria", "可璃亚(堕天使)", "可璃亚", "盾妹"],
    1261: ["普蕾西亚(堕落)", "プレシア(フォールン)", "Precia(Fallen)", "FPrecia", "普雷西娅(堕天使)", "普蕾西亚", "猪妹", "普雷西娅"],
    1262: ["伊莉亚(祭服)", "イリヤ(儀装束)", "Ilya(Costume)", "Illya(Ceremonial)", "CIllya", "伊莉亚(礼服)", "礼装伊莉亚", "礼装伊莉雅", "礼装伊利亚", "礼装yly", "礼服伊莉亚", "礼服伊莉雅", "礼服伊利亚", "礼服yly", "礼亚", "仪莉亚", "礼伊"],
    ...
    1268: ["优花梨(夏日)", "ユカリ(サマー)", "Yukari(Summer)", "SYukari", "由加莉(夏日)", "水黄", "泳装黄骑", "泳装酒鬼","水鬼"],
    1269: ["兰法(夏日)", "ランファ(サマー)", "Ranpha(summer)", "SRanpha", "泳装兰法", "水兰", "水兰法"],
    1270: ["空花(夏日)", "クウカ(サマー)", "Kuuka(summer)", "SKuuka", "泳装空花", "水M", "水空花", "水抖M", "泳装抖M","水m"],
    ...
    1273: ["铃奈(插班生)", "スズナ(編入生)", "Suzuna(Transfer Student)", "Suzuna(Student)", "TSSuzuna", "学暴", "雪豹","学爆"],

    1275: ["咲恋(萨拉萨利亚)", "サレン(サラサリア)", "Saren(Salasaria)", "SaSaren", "咲恋(沙漠)", "火电", "火电站", "火舞旋风", "沙电"],
    1276: ["流夏(萨拉萨利亚)", "ルカ(サラサリア)", "Ruka(Salasaria)", "SaRuka", "流夏(沙漠)", "流沙", "沙漠流夏", "沙夏"],
    1277: ["琳德", "リンド", "Lind", "龙姐"],
    1278: ["乌尔姆", "ヴルム", "Wurm", "维尔姆", "龙妹"],
    1279: ["贪吃佩可(圣诞节)", "ペコリーヌ(クリスマス)", "Pecorine(Christmas)", "Pecorine(Holiday)", "XPeco", "佩可莉姆(圣诞节)", "圣吃", "剩饭", "圣诞吃货", "圣诞佩可"],
    ...
    1285: ["霞(新年)", "カスミ(ニューイヤー)", "Kasumi(NewYear)", "NYKasumi", "香澄(新年)", "春驴", "新春驴", "新春香澄", "新春霞"],

    1287: ["日和(星素)", "ヒヨリ(アストラル)", "Hiyori(Astral)", "AHiyori", "日和莉(星幽)", "星猫", "⭐猫", "日和(星辰)"],
    1288: ["怜(星素)", "レイ(アストラル)", "Rei(Astral)", "ARei", "怜(星幽)", "星怜", "⭐怜", "星剑", "怜(星辰)"],
    1289: ["优衣(星素)", "ユイ(アストラル)", "Yui(Astral)", "AYui", "优衣(星幽)", "星优", "星u", "星优衣", "⭐优衣", "星田", "星衣", "⭐田", "⭐衣", "优衣(星辰)"],
    1290: ["厄莉丝", "エリス", "Elis", "Eris", "els", "厄里斯"],


    1293: ["优妮(冬日)", "ユニ(ウィンター)", "Yuni(Winter)", "WYuni", "水un", "水优妮", "水油腻", "水辈先","水U2"],
    1294: ["克萝依(冬日)", "クロエ(ウィンター)", "Kuroe(Winter)", "Chloe(Winter)", "WChloe", "克罗依(冬日)", "水华哥", "水华"],
    1295: ["琪爱儿(冬日)", "チエル(ウィンター)", "Chieru(Winter)", "WChieru", "千爱瑠(冬日)", "水切噜", "冬切噜", "水切", "冬切"],
    1296: ["安涅默涅", "アネモネ", "Anemone", "Anemos", "银莲", "银莲花"],
    1297: ["涅妃·涅罗", "ネフィ＝ネラ", "Nephi-Nera", "Nephi＝Nela", "Nefi=Nera", "涅妃＝涅菈", "涅妃"],
    1298: ["真琴(指挥官)", "マコト(コマンダー)", "Makoto(Commander)", "CoMakoto", "真琴(教官)", "战狼", "指狼", "指琴", "教官狼"],
    1299: ["惠理子(指挥官)", "エリコ(コマンダー)", "Eriko(Commander)", "CoEriko", "惠理子(教官)", "战病", "病教", "娇官", "指病", "军病", "交警", "娇警", "警病","教娇"],
    ...
    1307: ["镜华(春日)", "キョウカ(スプリング)", "Kyouka(Spring)", "Kyoka(Spring)", "SpKyouka", "花唯", "花仓唯", "花cw", "hcw"],
    1308: ["铃莓(春日)", "スズメ(スプリング)", "Suzume(Spring)", "SpSuzume", "春日女仆", "花女仆"],
    1309: ["库露露", "クルル", "Kururu", "宝石兔", "庫露露"],
    1310: ["真步(梦想乐园)", "マホ(ドリームパーク)", "Maho(DreamPark)", "DPMaho", "梦狐","烧狐"],
    1311: ["涅娅(夏日)", "ネア(サマー)", "Nea(Summer)", "SNea", "涅亚(夏日)", "夏娅", "涅娅夏日", "夏日涅娅", "水涅娅", "涅亚夏日", "夏日涅亚", "水涅亚", "水小黄"],
    1312: ["美空(夏日)", "ミソラ(サマー)", "Misora(Summer)", "SMisora", "美空夏日", "夏日美空", "水美空"],



    1316: ["莉莉(夏日)", "リリ(サマー)", "Riri(Summer)", "SRiri", "水莉", "水莉莉", "夏日莉莉", "莉莉夏日"],
    1317: ["爱梅斯(夏日)", "アメス(サマー)", "Amesu(Summer)", "Ameth(Summer)", "SAmeth", "水爱梅斯", "sms", "夏日爱梅斯", "水爱梅丝", "夏日爱梅丝", "水梅斯", "水爱", "水ms","水ems"],
    ...
    1323: ["露易丝玛莉", "ルイズマリー", "Louise-Marie", "露易丝玛丽", "鹿妹"],
    ...
    1330: ["格蕾斯", "グレイス", "Grace", "格蕾丝", "幽灵妹", "幽灵骑士"],
    1331: ["薇欧莉特", "ヴァイオレット", "Violet", "薇奥莉特", "紫罗兰", "薇尔莉特"],
    1332: ["莫妮卡(新年)", "モニカ(ニューイヤー)", "Monika(NewYear)", "NYMonika", "春二力", "新二力", "春莫妮卡", "新莫妮卡", "春毛", "春力"],


    1335: ["咲恋(新年)", "サレン(ニューイヤー)", "Saren(NewYear)", "NYSaren", "春咲", "春电"],
    1336: ["梅杜莎", "メドゥーサ", "Medusa", "美杜莎"],
    1337: ["拉比林斯达(始源)", "ラビリスタ(アルファ)", "Labyrista(Alpha)", "ALabyrista", "菈比莉斯塔(阿尔法)", "菈比莉斯塔(始源)", "原晶", "α晶", "阿晶"],
    1338: ["似似花(始源)", "ネネカ(アルファ)", "Neneka(Alpha)", "ANeneka", "似似花(阿尔法)", "原花", "α花", "阿花"],
    1339: ["克莉丝提娜(始源)", "クリスティーナ(アルファ)", "Kurisutiina(Alpha)", "AChristina", "克莉丝提娜(阿尔法)", "原克", "α克", "阿克"],
    1340: ["菲欧", "フィオ", "Fio"],
    ...
    1345: ["克萝茜(航空)", "クローチェ(エアリアル)", "Croce(Aerial)", "Croche(Aerial)", "ACroche", "克萝茜(空战)", "火机", "火鸡", "飞机"],
    1346: ["碧(驾驶员)", "アオイ(パイロット)", "Aoi(pilot)", "PAoi", "机菜", "荠菜", "机碧", "白菜"],
    1347: ["凤凰", "ホウオウ", "Phoenix", "Houou", "Ho-oh", "小凤", "肥鸡"],
    1348: ["纺希(吉欧·格黑纳)", "ツムギ(ジオ·ゲヘナ)", "Tsumugi(Geo Gehenna)", "GGTsumugi", "纺希(吉奥·矶汉拿)", "光裁", "吉欧裁缝"],
    1349: ["华音", "カノン", "Kanon", "花音", "伽音", "卡农"],
    1350: ["厄莉丝(夏日)", "エリス(サマー)", "Eris(Summer)", "SEris", "厄里斯(夏日)", "水厄里斯", "水厄", "水els","sls"],
    ...
    1353: ["可璃亚(夏日)", "クリア(サマー)", "Qulia(Summer)", "SQulia", "水可璃亚", "水璃亚", "水盾妹"],
    1354: ["安涅默涅(夏日)", "アネモネ(サマー)", "Anemone(Summer)", "SAnemone", "水银莲", "水银", "水莲"],
    1355: ["埃拉", "アイラ", "Aira", "艾拉"],
    1356: ["志那都", "シナツ", "Shinatsu", "诗夏"],
    1357: ["日和(萨拉萨利亚)", "ヒヨリ(サラサリア)", "Hiyori(Salasaria)", "SaHiyori", "日和莉(沙漠)", "沙猫拳", "沙猫"],
    1358: ["雪野", "ユキノ", "Yukino", "雪女", "雪乃"],
    1359: ["刹鬼", "サツキ", "Satsuki", "鬼娘", "鬼萝莉", "鬼妹", "皐月", "沙月"],
    1360: ["阿刺克涅", "アラクネ", "Arache", "阿拉克涅", "蜘蛛", "蜘蛛女"],
    1361: ["樱", "サクラ", "Sakura", "源樱", "肉樱"],
    1362: ["拿娜", "ナーナ", "Naana", "纳娜"],
    1363: ["美空(圣诞节)", "ミソラ(クリスマス)", "Misora(Holiday)", "圣美空", "圣诞美空"],
    1364: ["优衣(圣诞节)", "ユイ(クリスマス)", "Yui(Holiday)", "圣田", "圣衣", "圣UE", "圣优衣", "圣诞优衣"],
    1365: ["静流(新年)", "シズル(ニューイヤー)", "Shizuru(NewYear)", "NYShizuru", "春姐"],





    1371: ["妮诺(夏日)", "ニノン(サマー)", "Ninon(Summer)", "SNinon", "妮侬(夏日)", "水扇子", "水扇"],


    1374: ["霞(修道女)", "カスミ(シスター)", "Kasumi(Sister)", "SisKasumi", "香澄(修道女)", "修女驴", "修女霞", "修驴"],

    1376: ["可可萝(向导幼君)", "コッコロ(嚮導幼君)", "Kokkoro(Little Guidance)", "LGKokkoro", "导可", "大可", "导妈"],


    1379: ["璃乃(新年)", "リノ(ニューイヤー)", "Rino(NewYear)", "NYRino", "春弓", "春妹弓"],
    1380: ["薇欧莉特(伊邪那美)", "ヴァイオレット(イサナミ)", "Violet(Isanami)", "IViolet", "薇奥莉特(伊邪那美)", "水紫罗兰", "水紫"],
    1381: ["莱拉耶尔(完美)", "ライラエル(パルフェクト)", "Lyrael(Perfect)", "PLyrael", "完莱", "风莱"],
    1382: ["涅妃·涅罗(鬼面佛心)", "ネフィ＝ネラ(鬼面仏心)", "Nephi=Nella(Buddha)", "BNefi", "BNefi=Nera", "涅妃＝涅菈(鬼面佛心)", "鬼妃", "佛妃", "鬼涅", "佛涅"],
    1383: ["贪吃佩可(阿斯特赖亚)", "ペコリーヌ(アストライア)", "Pecorine(Astrea)", "佩可莉姆(阿斯特莱亚)", "阿吃", "火吃", "神吃", "王吃"],
 


    1387: ["若菜(冬日)", "ワカナ(ウィンター)", "Wakana(Winter)", "水若菜"],
    1388: ["栞(冬日)", "シオリ(ウィンター)", "Shiori(Winter)", "水栞"],
    1389: ["格蕾斯(兔女郎)", "グレイス(バニー)", "Grace(Bunny)", "BGrace", "格蕾丝(兔女郎)", "兔蕾丝", "兔蕾斯", "兔格"],
    1390: ["镜华(哥特)", "キョウカ(ゴシック)", "Kyouka(Gothic)", "GKyouka", "哥唯", "哥特唯", "暗唯", "黑唯", "gcw", "暗cw", "哥cw"],
    1391: ["凯留(霸瞳天星)", "キャル(霸瞳天星)", "Kyaru(Hadou Tensei)", "KKyaru", "凯露(霸瞳天星)", "霸猫", "天星猫"],
    1392: ["美穗(少女与战车)", "ミホ(ガルパン)", "Miho(Garupan)", "GPMiho", "美穗", "西住军神", "军神"],
    1393: ["真穗(少女与战车)", "マホ(ガルパン)", "Maho(Garupan)", "GPMaho", "真穗", "西住姐"],
    1394: ["艾丽卡(少女与战车)", "エリカ(ガルパン)", "Erika(Garupan)", "GPErika", "艾丽卡"],
    # =================================== #
    ...
    # =================================== #
    1801: ["日和(公主)", "ヒヨリ(プリンセス)", "Hiyori(Princess)", "PHiyori", "日和莉(公主)", "公主日和", "公猫", "炎拳猫", "火猫", "炎拳"],
    ...
    1807: ["初音&栞", "ハツネ&シオリ", "Hatsune&Shiori", "HatsuShio", "星弓", "星栞", "双子弓", "贴贴弓", "替身弓", "白金之星", "食堂泼辣酱", "初音栞", "星法栞"],
    1808: ["禊&美美&镜华", "ミソギ&ミミ&キョウカ", "Misogi&Mimi&Kyouka", "LLTrio", "未奏希&美美&镜华", "小小甜心", "狱三家", "小御三家","三小只"],
    1809: ["秋乃&咲恋", "アキノ&サレン", "Akino&Saren", "AkiSaren", "咲哈哈", "哈哈电", "哈哈咲", "哈电", "电哈", "光焰","笑哈哈"],
    1810: ["安&古蕾娅", "アン&グレア", "An&Gurea", "Anne&Grea", "安&古蕾雅", "双姬", "古安", "龙安"],
    1811: ["静流&璃乃", "シズル&リノ", "Shizuru&Rino", "ShizuRino", "流璃", "琉璃", "姐妹弓","姐&妹"],
...
CHARA_PROFILE = {
    ...
    1223: {"名字": "班比", "公会": "？？？", "生日": "？月？日", "年龄": "？？？", "身高": "149cm", "体重": "41kg", "血型": "AB", "种族": "魔族", "喜好": "散步、做饭", "声优": "钉宫理惠", "称号": "眷属的主人"},
    ...
    1331: {"名字": "薇欧莉特", "公会": "吉欧·尼布尔黑尔", "生日": "2月21日", "年龄": "17", "身高": "158cm", "体重": "49kg", "血型": "A", "种族": "人族", "喜好": "收集香水、阅读故事", "声优": "长绳麻理亚"},
    1336: {"名字": "梅杜莎", "公会": "？？？", "生日": "12月7日", "年龄": "14", "身高": "141cm", "体重": "？kg", "血型": "B", "种族": "妖魔人", "喜好": "与梅杜希亚娜翱翔天际", "声优": "水桥香织"},
    ...
    1349: {"名字": "华音", "公会": "吉欧·格黑纳", "生日": "10月9日", "年龄": "18", "身高": "155cm", "体重": "48kg", "血型": "B", "种族": "妖魔人", "喜好": "狩猎、收集珠宝", "声优": "幸村惠理"},
    1355: {"名字": "埃拉", "公会": "？？？", "生日": "3月27日", "年龄": "？？？", "身高": "162cm", "体重": "？kg", "血型": "？", "种族": "兽人族", "喜好": "助人为乐、逛街、品鉴啤酒", "声优": "松冈由贵"},
    1356: {"名字": "志那都", "公会": "？？？", "生日": "2月9日", "年龄": "？？？", "身高": "167cm", "体重": "？kg", "血型": "？", "种族": "魔族", "喜好": "武器保养、冥想、钓鱼", "声优": "皆川纯子"},
    1358: {"名字": "雪野", "公会": "吉欧·尼布尔黑尔", "生日": "12月30日", "年龄": "19", "身高": "179cm", "体重": "63kg", "血型": "O", "种族": "雪女", "喜好": "三味线、照顾死魔长尾山雀", "声优": "天野聪美"},
    1359: {"名字": "刹鬼", "公会": "吉欧·尼布尔黑尔", "生日": "2月2日", "年龄": "20", "身高": "135cm", "体重": "29kg", "血型": "O", "种族": "鬼族", "喜好": "与强敌过招、夜间巡逻", "声优": "岛袋美由利"},
    1360: {"名字": "阿刺克涅", "公会": "吉欧·格黑纳", "生日": "1月15日", "年龄": "28", "身高": "240cm", "体重": "108kg", "血型": "AB", "种族": "妖魔人", "喜好": "追逐光明、整理收拾", "声优": "远藤绫"},
    1361: {"名字": "樱", "公会": "？？？", "生日": "4月2日", "年龄": "享年17", "身高": "158cm", "体重": "46kg", "血型": "A", "种族": "僵尸", "喜好": "做点心、益智游戏", "声优": "本渡枫"},
    1362: {"名字": "拿娜", "公会": "吉欧·格黑纳", "生日": "2月10日", "年龄": "16", "身高": "152cm", "体重": "53kg", "血型": "O", "种族": "妖魔人", "喜好": "宅家、午睡", "声优": "黑泽朋世"},
    1392: {"名字": "美穗", "公会": "？？？", "生日": "10月23日", "年龄": "16", "身高": "158cm", "体重": "？kg", "血型": "A", "种族": "人族", "喜好": "收集毛绒玩具", "声优": "渊上舞"},
    1393: {"名字": "真穗", "公会": "？？？", "生日": "7月1日", "年龄": "18", "身高": "163cm", "体重": "？kg", "血型": "A", "种族": "兽人族", "喜好": "国际象棋", "声优": "田中理惠"},
    1394: {"名字": "艾丽卡", "公会": "？？？", "生日": "3月6日", "年龄": "16", "身高": "159cm", "体重": "？kg", "血型": "AB", "种族": "精灵族", "喜好": "健身拳击", "声优": "生天目仁美"},
}