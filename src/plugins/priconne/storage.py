...
ICON_CACHE_DIR = PRICONNE_DATA_DIR / "icons"
ICON_WARMUP_STATE_FILE = PRICONNE_DATA_DIR / "icon_warmup_state.json"
ARENA_DATA_DIR = PRICONNE_DATA_DIR / "arena"
ARENA_BUFFER_DIR = ARENA_DATA_DIR / "buffer"
ARENA_BUFFER_INDEX_FILE = ARENA_BUFFER_DIR / "buffer.json"
ARENA_DIC_FILE = ARENA_DATA_DIR / "dic.npy"
